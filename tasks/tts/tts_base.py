...
class TTSBaseTask(BaseTask):
    ...
    def train_dataloader(self):
        ...
        self.train_max_sentences = 32
        return self.build_dataloader(train_dataset, True, self.max_tokens, self.train_max_sentences,
    ...
    def build_dataloader(self, dataset, shuffle, max_tokens=None, max_sentences=None,
        ...
        # max_sentences를 고정 배치 사이즈로 설정
       #max_sentences = fixed_batch_size
